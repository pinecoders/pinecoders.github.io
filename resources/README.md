...
With experience in PineScript, Python, HTML, CSS, and EasyLanguage since 2014, Kenneth/@DayTradingOil is an aspiring Junior Developer with creative, outside-the-box thinking who looks forward to working with you to bring your ideas to life in TradingView. Services include Script/Alert Creation, Script Modifications, Automated Trading Systems, Custom Indicators, etc.<br><br>
